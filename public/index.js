...
var _index5 = require('./offert/index.js');

var _index6 = _interopRequireDefault(_index5);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

},{"./menu/index.js":4,"./offert/index.js":5,"./service/index.js":6}],3:[function(require,module,exports){
"use strict";
...
var $menuOfCanvas = (0, _jquery2.default)('.AppHeader-menuOfCanvas');
var $appHeaderButton = (0, _jquery2.default)('.AppHeader-button');
var $appHeaderbuttonCloset = (0, _jquery2.default)('.AppHeader-buttonCloset');

(0, _jquery2.default)($appHeaderButton).on('click', showHideMenu);
(0, _jquery2.default)($appHeaderbuttonCloset).on('click', showHideMenu);
...
var _responsiveslide = require('../lib/responsiveslide.js');

var _responsiveslide2 = _interopRequireDefault(_responsiveslide);
...
},{"../lib/responsiveslide.js":3,"jquery":1}],6:[function(require,module,exports){
'use strict';
...
renderService().then(function (services) {
  services.forEach(function (service) {
    var serviceTemplate = template.replace(':title:', service.title).replace(':text:', service.text).replace(':type1:', service.types[0]).replace(':type2:', service.types[1]).replace(':type3:', service.types[2]).replace(':type4:', service.types[3]).replace(':type5:', service.types[4]).replace(':type6:', service.types[5]).replace(':backgroundIcon:', service.backgroundIcon);
